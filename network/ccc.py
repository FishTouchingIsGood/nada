...
class Truncation(nn.Module):
    def __init__(self, avg_latent, max_layer=8, threshold=0.7):
        ...
        self.register_buffer('avg_latent',
                             avg_latent)  # parameter of the module which is not trainable and is not passed to the optimizer when calling parameters() function
